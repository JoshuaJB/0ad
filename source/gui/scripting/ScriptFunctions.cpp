...
/**
 * Attempt to open a hole in the NAT to a specified address.
 */
void PunchNAT(ScriptInterface::CxPrivate* UNUSED(pCxPrivate), std::string ipAddress)
{
	if(!g_NetServer)
	{
...
void GuiScriptingInit(ScriptInterface& scriptInterface)
{
	...
	scriptInterface.RegisterFunction<void, std::wstring, &JSI_Lobby::SendIP>("SendIP");
